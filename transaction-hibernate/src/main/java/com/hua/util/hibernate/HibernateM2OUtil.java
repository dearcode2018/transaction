 ...
 * HibernateM2OUtil
 */
public final class HibernateM2OUtil
{
	 ...
	 * 
	 */
	public static SessionFactory buildByXmlOf01() {
		if (null != factory) {
			
			return factory;
		}
		final String filePath = "/conf/hibernate/cfg/hibernate.cfg_m2o_01.xml";
		// 获取Hibernate配置对象
	 ...
	 * 
	 */
	public static SessionFactory buildByXmlOf02() {
		if (null != factory) {
			
			return factory;
		}
		final String filePath = "/conf/hibernate/cfg/hibernate.cfg_m2o_02.xml";
		// 获取Hibernate配置对象
		final Configuration configuration = getConfiguration(filePath);
