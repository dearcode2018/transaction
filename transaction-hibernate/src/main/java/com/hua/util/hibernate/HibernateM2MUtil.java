 ...
 * HibernateM2MUtil
 */
public final class HibernateM2MUtil
{
	...
	public static SessionFactory buildByXmlOf01() {
		...
		final String filePath = "/conf/hibernate/cfg/hibernate.cfg_m2m_01.xml";
		// 获取Hibernate配置对象
	...
	public static SessionFactory buildByXmlOf02() {
		...
		final String filePath = "/conf/hibernate/cfg/hibernate.cfg_m2m_02.xml";
		// 获取Hibernate配置对象
		final Configuration configuration = getConfiguration(filePath);
