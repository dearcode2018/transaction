 ...
 * OneToOne_03Test
 */
public final class OneToOne_03Test extends BaseTest
{
	/* SessionFactory */
	public static final SessionFactory factory = HibernateO2OUtil.buildByXml_03();
	...
	public void testInsert01() {
		try {
			...
			// 持久化操作
			/**
			 * 2者通过中间表来建立关系，需要分别保存，然后中间表才能执行保存.
			 */
			session.save(person);
			session.save(idCard);
