/**
 * 描述: 
 * JdbcTransactionReadCommittedTest.java
 * 
 * @author qye.zheng
 *  version 1.0
 */
 ...
 * 
 * @author qye.zheng
 * JdbcTransactionReadCommittedTest
 */
public final class JdbcTransactionReadCommittedTest extends BaseTest {
	...
	public void testJdbcTransaction() {
		try {
			 ...
			 */
			// 设置事务隔离级别 TRANSACTION_READ_COMMITTED
	...
	public void testJdbcTransactionA() {
		try {
			...
			resultSet.next();
			System.out.println("客户端B尚未提交: " + resultSet.getLong(1));
			...
			resultSet.next();
			System.out.println("客户端B已经提交: " + resultSet.getLong(1));
